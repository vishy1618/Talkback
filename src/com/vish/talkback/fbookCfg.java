...
public class fbookCfg extends Activity {
	DBManager db;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fbook_cfg);
        setResult(-1);
        
        final Button discard = (Button)findViewById(R.id.fbook_discard);
        ...
        final Button save = (Button)findViewById(R.id.fbook_save);
    ...
    private void onSave() {
    	EditText userText = (EditText)findViewById(R.id.fbook_user);
    	EditText passText = (EditText)findViewById(R.id.fbook_passwd);
        ...
        Intent chatRosterIntent = new Intent(fbookCfg.this,chatRoster.class);
